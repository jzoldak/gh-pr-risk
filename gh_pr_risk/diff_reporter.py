...
Taken from diff-cover:  https://github.com/edx/diff-cover
"""
...
class GitDiffReporter(BaseDiffReporter):
    ...
    NAME = 'Commit Diff from GitHub'

    def __init__(self, diff):
        """
        Initialization for the reporter object
        """
        super(GitDiffReporter, self).__init__(self.NAME)

        # Use the diff given as the data for the report
        self.diff = diff
